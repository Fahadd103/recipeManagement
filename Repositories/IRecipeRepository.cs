...
namespace RecipeManagementSystem.Repositories
{
    public interface IRecipeRepository
    {
        ...
        Task<IEnumerable<Recipe>> SearchRecipesAsync(string query, string category);
    }
}
...
namespace RecipeManagementSystem.Repositories
{
    public class RecipeRepository : IRecipeRepository
    {
        ...
        public async Task<IEnumerable<Recipe>> SearchRecipesAsync(string query, string category)
        {
            ...
            {
                filter = filter & Builders<Recipe>.Filter.Eq(r => r.Category, category);
            }
